...
public class TATETI {
	...
	/*
	 * TRABAJO PARA ENTREGAR EN GIT TATETI: Se tiene Un tablero de 3 x 3 matriz
	 * [fila][columna] Dos jugadores que ingresan las coordenadas de cada ficha por
	 * teclado Una vez que tengo fila y columna de la ficha, muestro el tablero con
	 * X o 0 Verificar si es posible la posicion de la ficha y ver si hay ganador
	 * Mientras no haya ganador continua el siguiente jugador
	 * 
	 * | | ---|---|--- fila columna | | X -> tablero[1][2] ---|---|---- | |
	 * 
	 * Bugs:
	 * 
	 * 1. Contador de turnos, empezar con jugador 1 2. Ficha no valida saltea al
	 * jugador 3. Falta validacion de coordenadas la ficha
	 */
